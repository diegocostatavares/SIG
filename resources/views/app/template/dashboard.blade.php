                    ...
                    <div class="inbox-widget nicescroll" style="height: 339px;">
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-1.jpg')}}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-2.jpg')}}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-3.jpg')}}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-4.jpg')}}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-5.jpg')}}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-6.jpg')}}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-8.jpg')}}" class="rounded-circle" alt=""></div>
                        ...
                        <a href="#">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{asset('assets/app/images/users/avatar-9.jpg')}}" class="rounded-circle" alt=""></div>
...
<!--Morris Chart-->
<script src="{{asset('assets/app/plugins/morris/morris.min.js')}}"></script>
