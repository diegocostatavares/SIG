...
@can('auth_permission', $route_name.'.visualizar')
    @php
    	...
    	$button_class_visualizar = 'btn btn-success btn-sm active';
    	$i_class_visualizar = 'zmdi zmdi-eye active';
    @endphp
@else
    @php
    	$a_href_visualizar = '';
    	$button_class_visualizar = 'btn btn-success btn-sm disabled';
    	$i_class_visualizar = 'zmdi zmdi-eye-off disabled';
    @endphp
@endcan
...
@can('auth_permission', $route_name.'.editar')
    @php
    	...
    	$button_class_editar = 'btn btn-primary btn-sm active';
    	$i_class_editar = 'zmdi zmdi-edit active';
    @endphp
@else
    @php
    	$a_href_editar = '';
    	$button_class_editar = 'btn btn-primary btn-sm disabled';
...
@can('auth_permission', $route_name.'.excluir')
    @php
    	...
    	$button_class_deletar = 'btn btn-danger btn-sm active';
    	$i_class_deletar = 'zmdi zmdi-delete active';
    @endphp
@else
    @php
    	$a_href_deletar = '';
    	$button_class_deletar = 'btn btn-danger btn-sm disabled';
